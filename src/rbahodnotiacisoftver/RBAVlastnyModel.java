...
public class RBAVlastnyModel extends javax.swing.JFrame {
    ...
    void LoadTeams() {
        ...
        VMTeams = new ArrayList<>();
        try (ObjectInputStream VMin = new ObjectInputStream(new FileInputStream("VM.res"))) {

            VMTeams = (List<TeamVM>) VMin.readObject();

        } catch (IOException ex) {
            JOptionPane.showMessageDialog(null, "Súbor VM.res sa nedá čítať skontrolujte, \nči súbor VM.res existuje a či je v dobrom adresári ", "RBA", JOptionPane.WARNING_MESSAGE);
            RBAHodnotiaciSoftver.ChangeMode(Modes.ADMINISTRACIA);
        } catch (ClassNotFoundException ex) {
            JOptionPane.showMessageDialog(null, "Súbor VM.res bol poškodený,\nvygenerujte novú výsledkovú listinu", "RBA", JOptionPane.WARNING_MESSAGE);
            RBAHodnotiaciSoftver.ChangeMode(Modes.ADMINISTRACIA);
    ...
    JMenuBar CreateMenu() {
        ...
        overview.addActionListener((ActionEvent e) -> {
            ...
            FormOverview.InitTable(WrapData(), header);
            FormOverview.InitVMBTN();
...
JOptionPane.showMessageDialog(null, "Tím neexistuje", "RBA", JOptionPane.ERROR_MESSAGE);
    ...
    void SerializeTeams(String label) {
        try (ObjectOutputStream VMin = new ObjectOutputStream(new FileOutputStream("VM" + label + ".res"))) {

            VMin.writeObject(VMTeams);

        } catch (IOException ex) {
            JOptionPane.showMessageDialog(null, "Chyba pri ukladaní výsledkov do súboru VM"+label+".res", "RBA", JOptionPane.WARNING_MESSAGE);
        }
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(TeamsComboBox, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RBAVlastnyModel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RBAVlastnyModel().setVisible(true);
            }
        });
    }
